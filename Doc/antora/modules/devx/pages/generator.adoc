...
- the Dto project is placed in the `${target_directory}/${dto_project_name}` directory
- the Dto project file is placed in the `${target_directory}/${dto_project_name}` directory with the name of `${dto_project_name}.${solution_project_file_type}`, e.g. in case of C# it is `.csproj`
...
The Dto Project Path defines a relative path from the `${TargetDirectory}`.
This value has to be relative and cannot step backwards, e.g. cannot have value like `./..`

.Providing "Dto Project Path" configuration value via json configuration
[source,json]
----
{
  "dto_project_path": "DtoProject/PathValue"
}
----
...
|Includes other than alphanumeric
|throws
...
=== Dto Project Filetype

The Dto project file type defines the project file type.
The generator looks for the type.
The other use of this parameter is during testing.

.Providing "Dto Project File Type" configuration value via json configuration
[source, json]
----
{
  "dto_project_file_type": "sln"
}
----
...
|Includes other than alphanumeric letters
|throws

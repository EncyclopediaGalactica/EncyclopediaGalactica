use anyhow::ensure;
use galsim_astro::distance_by_coordinates::calculate_distance_by_coordinates;
...
use galsim_objects::star_system::scenario_entities::two_star_systems_distance_scenario_input::TwoStarSystemsDistanceScenarioInput;
use galsim_objects::star_system::scenario_entities::two_star_systems_distance_scenario_result::TwoStarSystemsDistanceScenarioResult;
use sqlx::PgPool;

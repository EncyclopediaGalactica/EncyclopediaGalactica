use galsim_objects::moon::scenario_entities::get_all_moons_scenario_input::GetAllMoonsScenarioInput;
use galsim_objects::moon::scenario_entities::get_all_moons_scenario_result::GetAllMoonsScenarioResult;
use galsim_storage::moon::get_all::get_all_moons;
use sqlx::PgPool;

...
use galsim_objects::star_system::scenario_entities::add_star_system_scenario_result::AddStarSystemScenarioResult;
use galsim_storage::star_system::add::add_star_system;
use sqlx::PgPool;

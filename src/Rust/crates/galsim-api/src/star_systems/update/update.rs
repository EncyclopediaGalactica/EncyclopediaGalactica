...
use galsim_objects::star_system::scenario_entities::update_star_system_scenario_result::UpdateStarSystemScenarioResult;
use galsim_storage::star_system::update_by_id::update_by_id;
use sqlx::PgPool;

use galsim_objects::star::scenario_entities::update_star_scenario_input::UpdateStarScenarioInput;
use galsim_objects::star::scenario_entities::update_star_scenario_result::UpdateStarScenarioResult;
use galsim_storage::star::update_by_id::update_star_by_id;
use sqlx::PgPool;

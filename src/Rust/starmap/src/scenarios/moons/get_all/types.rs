...
impl From<MoonEntity> for GetAllMoonsScenarioResult {
    fn from(entity: MoonEntity) -> Self {
        GetAllMoonsScenarioResult::new(entity.id, entity.name, entity.description)
    }
}
...
mod tests {
    ...
    fn test_get_all_moons_scenario_result_new() {
        let result = GetAllMoonsScenarioResult::new(1, "Luna".to_string(), "Earth's moon".to_string());

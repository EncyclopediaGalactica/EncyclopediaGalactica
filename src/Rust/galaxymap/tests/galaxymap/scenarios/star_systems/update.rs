...
use galaxymap::scenarios::star_systems::update::types::UpdateStarSystemScenarioInput;
use galaxymap::scenarios::star_systems::update::update::update_star_system_scenario;
use sqlx::PgPool;
use sqlx::Result;

...
use galaxymap::scenarios::star_systems::delete::delete::delete_star_system_scenario;
use galaxymap::scenarios::star_systems::delete::types::DeleteStarSystemScenarioInput;

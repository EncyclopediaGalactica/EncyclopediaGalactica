...
public sealed class DeleteEdgeCommand : Command<DeleteEdgeCommand.Settings>
{
    public override int Execute(CommandContext context, Settings settings)
    {
        ...
        //                 }
        //             );
        Console.WriteLine("List edge type");
        return 0;
    }
    ...
    {
        [CommandOption("--id")]
        [Description("The edge id that going to be deleted.")]

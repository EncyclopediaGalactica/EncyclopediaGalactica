namespace EncyclopediaGalactica.RestApiSdkGenerator.Generator.Tests.Unit.e2e.solution_project_file_type;
...
public class SolutionProjectFileTypeShould : TestBase
{
    private readonly string _currentPath;

    public SolutionProjectFileTypeShould(ITestOutputHelper outputHelper) : base(outputHelper)
    {
    ...
    public void SolutionProjectFileType_Throws_WhenInputIsInvalid(string fileName)
    {
        // Arrange
